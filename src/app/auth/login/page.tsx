        ...
        <div className="min-h-screen bg-soft-white flex">
            ...
            <div className="hidden lg:flex flex-1 hero-gradient items-center justify-center p-12 relative overflow-hidden">
                ...
                <div className="relative text-center max-w-md">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-turkuaz to-turkuaz-light flex items-center justify-center mx-auto mb-8 shadow-lg shadow-turkuaz/20">
                        <Plane className="w-8 h-8 text-white -rotate-45" />
                    </div>
                    <h2 className="text-3xl font-bold text-white font-montserrat mb-4">
                        Tatilva'ya <span className="gradient-text">Hoş Geldiniz</span>
                    </h2>
                    <p className="text-white/50 leading-relaxed">
                        Binlerce site gezmek yerine aradığınız her şey Tatilva'da. Bütçenizi belirleyin, rotanızı bulun.
                    </p>
                </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
                <div className="w-full max-w-md">
                    <div className="mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-navy font-montserrat mb-2">Giriş Yap</h1>
                        <p className="text-gray-400 text-sm">Hesabınıza giriş yaparak tatil planlamaya devam edin.</p>
                    </div>
                    ...
                    {isSubmitted ? (
                        <div className="text-center py-12 animate-fade-in-up">
                            ...
                            <h3 className="text-xl font-bold text-navy font-montserrat mb-2">Hoş Geldiniz!</h3>
                            <p className="text-gray-500 text-sm mb-4">Giriş başarılı. Yönlendiriliyorsunuz...</p>
                            <Link href="/" className="text-turkuaz font-medium text-sm hover:underline">Ana Sayfaya Git →</Link>
                        </div>
                    ) : (
                        <>
                            {/* Social Login */}
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                <div>
                                    <label className="flex items-center gap-2 text-sm font-medium text-navy mb-1.5">
                                        <Lock className="w-3.5 h-3.5 text-turkuaz" />
                                        Şifre
                                    </label>
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-turkuaz focus:ring-2 focus:ring-turkuaz/20 outline-none transition-all text-sm pr-12"
                                            placeholder="••••••••"
                                        />
                                        <button
                                            type="button"
                                ...
                                <div className="flex items-center justify-between">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-turkuaz focus:ring-turkuaz" />
                                        <span className="text-sm text-gray-500">Beni hatırla</span>
                                    </label>
                                    <a href="#" className="text-sm text-turkuaz hover:underline">Şifremi unuttum</a>
                                </div>
                            ...
                            <p className="text-center text-sm text-gray-400 mt-6">
                                Hesabınız yok mu?{" "}
                                <Link href="/auth/register" className="text-turkuaz font-medium hover:underline">Kayıt Ol</Link>
                            </p>
                        </>
                    )}
                </div>
